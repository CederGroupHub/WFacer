...
from pymatgen import Specie,Structure,Element
...
class Assignment(ABC):
    ...
    @abstractmethod
    def assign(str_pool,properties):
        """
...
class MagChargeAssignment(Assignment):
    """
    Assign charges from magnitudes of magentic moments. Partition dividers will be moved and 
    optimized to get maximum number of structures assigned as charge neutral.
