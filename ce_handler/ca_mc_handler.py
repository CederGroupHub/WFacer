...
from smol.moca.ensemble import CanonicalEnsemble
from smol.moca import Sampler

from .base import MCHandler
...
##TODO: move some unnecessary functions to MCHandler class in base.py
...
class CanonicalMCHandler(MCHandler):
    ...
    def __init__(self,ce,sc_mat,compstat,\
        ...
        self._gs_occu = gs_occu or self._initialize_occu()
    ...
    def solve(self):
        """
        Use simulated annealing to solve a ground state.
        ...
        gs_e = list(sampler.samples.get_minimum_energy())
    ...
    def _initialize_occu(self):
        ...
        for i in range(50):
            ...
            for sl_id, (sl_int_comp, sl_sites) in enumerate(zip(self.int_comp,self.sc_sublat_list)):
