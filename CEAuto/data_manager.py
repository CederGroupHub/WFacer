...
class DataManager:
    ...
    def comp_df(self):
        ...
        Has following columns:
            ...
            sc_id(int):
                ...
                For example, a supercell of size 2 can not have
                {'A':0.333,'B':0.667}, etc.
            ucoord(List[float]):
    ...
    def insert_one_comp(self, new_comp, sc_id=None, sc_mat=None,
                        comp_format='unconstr'):
        ...
        Args:
            ...
            sc_id(int):
                ...
                sc_mat argument can't be both None. If you know the sc_id, you
    ...
    def remove_supercells_by_id(self, sc_ids=[]):
        ...
        drop_ids_in_sdf = (self.sc_df.
                           ...
                           .tolist())
        drop_ids_in_cdf = (self.comp_df.
                           index[self.comp_df.sc_id.isin(sc_ids)]
                           .tolist())
        drop_ids_in_fdf = (self.fact_df.
    ...
    def _reassign_sc_ids(self):
        ...
        All fact_df, comp_df and sc_df will be re-indexed.
